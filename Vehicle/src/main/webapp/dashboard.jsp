...
<body>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card" style="width: 18rem; height : 21rem;">
            ...
            <img src="https://d2m3nfprmhqjvd.cloudfront.net/blog/20220629230814/RC-IN-Gurgaon-1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
    ...
    <footer class="footer">
        ...
        <h1 id = "ganesh">Developed by Vedant Raut and Team</h1>
        <p id="copyright">Copyright 2023 MotorHub</p>
        </div>
    </footer>
